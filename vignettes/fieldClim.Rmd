...
test_station <- build_weather_station(lat = 50.840503,
                                      ...
                                      depth2 = 0.3,
                                      ts1 = ws$t_surface,
                                      ts2 = ws$t_surface-0.1,
                                      moisture = ws$water_vol_soil)
```

Many of the parameters can also be estimated using different parameters.
Below is an overview on what can be omitted or estimated another way.
